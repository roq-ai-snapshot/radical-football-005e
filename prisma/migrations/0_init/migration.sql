...
-- AddForeignKey
ALTER TABLE "coach_player" ADD CONSTRAINT "coach_player_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
